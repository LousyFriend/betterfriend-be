...
// not sure how I feel about all this modularity haha. Seems like it's getting a little cumbersome to have all these files to import from, which has the effect of making your code less dry (each file, each import is another opportunity for a typo or weird pathing issue, or capitalization issue between linux vs mac)
...
// CONTACT ROUTES
// if you export a function, you can just refer to it here without the parens. The parens only worked because your filed exported these weird 'function makers' (functions that return a function), which could have been cool if they took in arguments, but since they didn't, they were just extra complexity. I would expect this to work below
